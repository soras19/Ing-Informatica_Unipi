...
int main(){
  ...
  cout << "\nTest della set. Deve stampare: < 5 7 -3 6 >" << endl;
  v.set(0, 5);     // imposta a 5 il primo elemento
  v.set(1, 7);     // imposta a 7 il secondo elemento
  v.set(2, -3);    // imposta a -3 il terzo elemento
  v.set(3, 6);     // imposta a 6 il quarto elemento
  cout << v << endl;

  cout << "\nTest della set oltre l'attuale dimensione. Deve stampare: < 5 7 -3 6 0 7 >" << endl;
  v.set(5, 7);
  cout << v << endl;
  ...
  cout << "Testa della azzera. Deve stampare: < 5 7 0 0 0 7 >\n";
  v.azzera();
  cout << v << endl;
